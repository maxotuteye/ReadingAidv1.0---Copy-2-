...
public class AboutSummarizer
{
    public static void main(String[] args)
    {
        String toBeSummed = new String("");
        AboutSummarizer summarizer = new AboutSummarizer();

        //System.out.print(summarizer.Summarize(toBeSummed, 10));
       // System.out.print("hello everyone");
    }
    public AboutSummarizer(){}//default constructor
